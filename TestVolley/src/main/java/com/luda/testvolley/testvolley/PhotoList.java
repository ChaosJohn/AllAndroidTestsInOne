...
//        Log.d("Test concatenateRequestUrlFromBaseUrlAndParams", OtherUtils.concatenateRequestUrlFromBaseUrlAndParams("http://www.baidu.com", "a=1", "b=2", "c=3"));

//        Toast.makeText(getApplicationContext(), OtherUtils.concatenateRequestUrlFromBaseUrlAndParams("http://www.baidu.com", "a=1", "b=2", "c=3"), Toast.LENGTH_LONG).show();
